...
public class PermissionUtils {
    ...
    private static String[] PERMISSIONS = {Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.READ_PHONE_STATE};
    ...
    public boolean hasPermissions(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (PackageManager.PERMISSION_DENIED == context.checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                //-Logging.w(TAG, "has not permission " + Manifest.permission.CAMERA);
                return false;
            }
            if (PackageManager.PERMISSION_DENIED == context.checkSelfPermission(Manifest.permission.READ_PHONE_STATE)) {
                //-Logging.w(TAG, "has not permission " + Manifest.permission.CAMERA);
                return false;
            }
